...
QJsonArray FluTheme::segoeIconList(const QString& keyword) {
    QJsonArray arr;
    QMetaEnum enumType = Fluent_SegoeIcon::staticMetaObject.enumerator(Fluent_SegoeIcon::staticMetaObject.indexOfEnumerator("Fluent_SegoeIconType"));
