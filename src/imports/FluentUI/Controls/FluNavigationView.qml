    ...
    Rectangle{
        ...
        color: {
            ...
            if(Window.window.active){
                return FluTheme.dark ? Qt.rgba(26/255,34/255,41/255,0.3) : Qt.rgba(238/255,244/255,249/255,0.3)
            }
            return FluTheme.dark ? Qt.rgba(32/255,32/255,32/255,0.3) : Qt.rgba(243/255,243/255,243/255,0.3)
        }
        Behavior on color{
            ColorAnimation {
                duration: 300
